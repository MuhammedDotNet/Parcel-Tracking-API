...
public interface IAnalyticsService
{
    ...
    Task<DeliveryStatsResponse> GetDeliveryStatsAsync(DateTimeOffset from, DateTimeOffset to, CancellationToken ct = default);
    ...
    Task<List<ExceptionReasonResponse>> GetTopExceptionReasonsAsync(DateTimeOffset from, DateTimeOffset to, CancellationToken ct = default);
    ...
    Task<List<ServiceBreakdownResponse>> GetServiceBreakdownAsync(DateTimeOffset from, DateTimeOffset to, CancellationToken ct = default);
    ...
    Task<List<PipelineStatusResponse>> GetPipelineAsync(CancellationToken ct = default);
}
